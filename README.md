...
This project explores how to fine-tune a **transformer** for a custom text completion task -- specifically, we'll teach `distilgpt2`, a faster, smaller version of GPT-2  how to generate full recipes from a dataset of ingredient-instruction pairings.
